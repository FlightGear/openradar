package cz.muni.fi.openradar.ui;
...
public class HlaSetupDialog extends JDialog implements ActionListener {
    ...
    protected void populateRecentSectorsList() {
        Preferences preferences = Preferences.userNodeForPackage(HlaSetupDialog.class);
