...
public class FlightStripCellRendererSim extends JComponent implements ListCellRenderer<GuiRadarContact> {
	...
	public FlightStripCellRendererSim(GuiMasterController master) {
		//this.master=master;
