...
public class FlightStripCellRendererPureSim extends JComponent implements ListCellRenderer<GuiRadarContact> {
	...
	public FlightStripCellRendererPureSim(GuiMasterController master) {
		//this.master=master;
