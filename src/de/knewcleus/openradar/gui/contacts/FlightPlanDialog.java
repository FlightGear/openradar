...
public class FlightPlanDialog extends JDialog implements FocusListener {
	...
	private void initFlightDetails(JPanel jPnlFlight) {
		...
		btRetrieveFp.setEnabled(master.getAirportData().isFpDownloadEnabled());
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 4;
		gridBagConstraints.gridy = 0;
		gridBagConstraints.weightx = 1.0;
		...
		btCloseFp.setEnabled(master.getAirportData().isFpDownloadEnabled());
		gridBagConstraints = new java.awt.GridBagConstraints();
		gridBagConstraints.gridx = 5;
		gridBagConstraints.gridy = 0;
		gridBagConstraints.weightx = 0.0;
	...
	private void setFpReadable(boolean b) {
		...
		btRetrieveFp.setEnabled(b && master.getAirportData().isFpDownloadEnabled());
	}
	...
	private class CbRunwayActionListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource().equals(cbAssignedRunway)) {
				...
				master.getAirportData().getNavaidDB().updateRoutesCbModel(
						(DefaultComboBoxModel<String>) cbAssignedRoute.getModel(), master,
						(String) cbAssignedRunway.getSelectedItem(), true);
