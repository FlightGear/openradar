...
import de.knewcleus.openradar.view.objects.RunwayEndCenterLine;
...
public class RunwayEndPainter extends AViewObjectPainter<RunwayEnd> {
    ...
    public RunwayEndPainter(IMapViewerAdapter mapViewAdapter, RunwayEnd runwayEnd) {
        super(mapViewAdapter, runwayEnd);
        
        Font font = new Font("Arial", Font.PLAIN, 9);
        
        RunwayEndIlsCone ils = new RunwayEndIlsCone(runwayEnd);
